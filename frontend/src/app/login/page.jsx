    ...
    <div className="min-h-screen flex items-center justify-center bg-[#f5fafd]">
      <div className="bg-white shadow-xl p-8 w-full max-w-md">
          ...
          >
            <svg width="24" height="24" viewBox="0 0 48 48">
              <g>
                ...
                <path fill="#EA4335" d="M44.5 20H24v8.5h11.7c-1.2 3.2-4.2 5.5-7.7 5.5-4.7 0-8.5-3.8-8.5-8.5s3.8-8.5 8.5-8.5c2.1 0 4 .7 5.5 2.1l6.1-6.1C37.9 10.1 31.7 7 24 7c-8.9 0-16.3 7.2-16.3 16.3S15.1 39 24 39c7.7 0 13.9-3.1 17.5-8.1l-7-5.4C34.7 33.1 30.1 36 24 36c-6.6 0-12-5.4-12-12s5.4-12 12-12c3.1 0 5.9 1.1 8.1 2.9l6.1-6.1C34.5 6.5 29.6 4 24 4 12.9 4 4 12.9 4 24s8.9 20 20 20z"/>
              </g>
            </svg>
        ...
        <div className="text-right mt-4">
          <a href="#" className="text-blue-700 hover:underline text-base">
            Forgot password?
          </a>
        </div>
      </div>
